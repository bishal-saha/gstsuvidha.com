        ...
        <div class="panel">
            <div class="panel-body">
                <div class="brand">
                    ...
                    <h1 class="brand-text font-size-24">KINETIC GST SUVIDHA</h1>
                ...
                <form method="POST" action="{{ route('password.email') }}">
                    ...
                    <button type="submit" class="btn btn-primary btn-block btn-lg mt-40">Send Password Reset Link</button>
                    <a href="{{ route('login') }}"><button class="btn btn-info btn-block btn-lg mt-40">Login</button></a>
                </form>
            </div>
        </div>
